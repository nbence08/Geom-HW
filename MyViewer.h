...
private:
  ...
  void derivativeControlPoints(size_t d, std::vector<std::vector<double>>& dcp) const;
  std::vector<double> derivativesByControlPoints(double u, size_t d, std::vector<std::vector<double>>& der);
  ...
  std::unordered_map<MyMesh::VertexHandle, std::pair<double, double>> uvs;
  // Visualization
